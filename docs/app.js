;(function() {
  ...
  var line_options = { chart: { width: window.innerWidth, height: 290 / 800 * window.innerWidth },
    xAxis: 
     { data: [ 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014 ],
       label: { align: 'center' } },
    yAxis: { min: 0, label: { align: 'left' } },
    legend: { enable: false , marginTop: 20} };
  ...
  var score_options = { chart: { width: window.innerWidth, height: 290 / 800 * window.innerWidth },
  xAxis: 
   { grid: { enable: false },
     tick: { align: 'center' },
     label: { align: 'center' },
